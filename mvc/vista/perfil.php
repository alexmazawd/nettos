                                ...
                                <div class="user_profile">
                                    ...
                                    <div class="user_pro_status">
                                        ...
                                        <ul class="flw-hr" id="contBtnSeguir">
                                            <li id="insertaBtn">
                                                <button class="bot" type="button" id="btnSeguir"
                                                        onclick="peticionAJAXRelacionUser()">
        ...
        <div class="post-project">
            ...
            <div class="post-project-fields">
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-12">
                            <textarea oninput="validarNett()" name="nett" id="nett" maxlength="140"
                        ...
                        <div class="col-lg-12">
                            <ul>
                                <li>
                                    <button class="active" disabled="disabled" type="submit" id="envio1Nett" value="post" onclick="peticionAJAX()">Publicar
                                        Nett
                                    </button>
                                </li>
